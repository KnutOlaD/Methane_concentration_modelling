...
class streamlines:
    ...
    def get_streamlines(
        self, 
        u, v, 
        xlim = None, ylim = None, res = None, 
        new_initial = False, 
        axes = None,
    ):
        '''
        get streamlines computes streamlines for given u,v field

        input:
        u, v:        Horizontal components of velocities at any sigma layer (or vertical average flow)
        xlim, ylim:  Extent of domain you want streamlines within
        res:         Resolution of initial field for "particles" we use to draw streamlines
        new_initial: True, if you want to use new initial positions
        '''
